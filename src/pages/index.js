        ...
        <div id="main">
            ...
            <div className="spotlight">
              <div className="content">
                ...
                <p>
                  ...
                  information from NASA including their ever popular
                  Astronomy Picture of the Day and mars rovers data.
                </p>
                <p>
                  spacebot adds a new <code>/spacebot</code> slash command to your slack channels to allow you to easily see new and interesting images about space, astronomy, mars, and more. See the usage section below for details on the lists of available commands.
                </p>
                <p>
                  NASA currently has two rovers that are exploring the
                  surface of Mars, Curiosity and Opportunity. Opportunity
                  was launched in 2003, while Curiosity was launched in
                  2011. Spirit was also launched as the second rover of the
                  pair in 2003 but became disabled and ultimately
                  decommissioned in 2011.
                </p>
                <ul className="actions">
                  <li>
                    <a href="https://whosay.slack.com/apps/A267XPPFT-spacebot" className="button">
          ...
          <section id="first" className="main special">
            ...
            <footer className="major">
              <ul className="actions">
                <li>
                  <a href="https://get.slack.help/hc/en-us/articles/202035138-Add-an-app-to-your-workspace" className="button">
          ...
          <section id="second" className="main special">
            <header className="major">
              ...
              <p>
                After installing spacebot, there are several "slash" commands spacebot understands. Check back as more commands will be added, or run <code
                >
                  /spacebot help
                </code> within slack.
              </p>
            ...
            <h3>APOD</h3>
            <p>
              The <a href="http://apod.nasa.gov/apod/astropix.html">
            ...
            <header className="major">
              ...
              <p>
                <span role="img" aria-label="Rocket">
                  🚀
                </span> Install spacebot now and start finding your favorite Mars and space photos now.
              </p>
            </header>
          </section>
        </div>
